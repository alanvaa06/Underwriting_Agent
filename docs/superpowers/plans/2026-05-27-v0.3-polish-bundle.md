...
- [x] **Step 1: Update test — add async + usage assertions + callback_factory arg**
...
- [x] **Step 3: Rewrite `underwriter/graph.py`**
...
- [x] **Step 1: Update `app/schemas.py` — extend EventType**
...
- [x] **Step 2: Write failing tests in tests/test_streaming.py**
...
- [x] **Step 4: Rewrite `underwriter/streaming.py`**
...
- [x] **Step 5: Run streaming tests + full suite**
...
- [x] **Step 1: Create `frontend/dark.js`**
...
- [x] **Step 2: Add `setTheme` export to `frontend/graph.js`**
...
- [x] **Step 3: Update `frontend/index.html`** — three changes
...
- [x] **Step 4: Manual smoke (cannot automate)**
...
- [x] **Step 1: Create `frontend/pdf.js`**
...
- [x] **Step 2: Update `frontend/index.html`** — add jsPDF CDN + Download button + script load
...
- [x] **Step 3: Update `frontend/app.js`** — add currentState accumulator + button wire
...
- [x] **Step 1: Add cost table markup inside decision card**
...
- [x] **Step 2: Implement cost render + token append in `frontend/app.js`**
...
- [x] **Step 3: Run full pytest suite**
...
- [x] **Step 1: Create `frontend/i18n.js`**
...
- [x] **Step 2: Update `frontend/index.html`** — add `data-i18n*` attrs + EN/ES toggle + script load
...
- [x] **Step 3: Update `frontend/app.js`** — translate error messages
...
- [x] **Step 4: Verify `data-i18n` count**
...
- [x] **Step 5: Run full pytest suite**
