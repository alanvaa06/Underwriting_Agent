...
- [ ] **Step 1: Make all 6 agent node functions async + return usage**
...
- [ ] **Step 2: Update each agent test to async + assert usage in delta**
...
- [ ] **Step 3: Run each agent test file individually — verify pass**
